...
I'm a software engineer with 5+ years of experience. I work in fields like REST-APIs, web scraping and machine learning using 
technologies such as python (flask and fastAPI frameworks), SQL, selenium, scrapy, bs4, web stack (JS, HTML and CSS), 
scikit-learn and pyspark for ML tasks.

I also have experience in cloud technologies such as AWS, Docker, Apache Kafka and Kubernetes.
